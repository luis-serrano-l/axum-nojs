...
skip_exists: true
message: "Views `views::{{ snake_plural }}` (Maud, axum-nojs) were added successfully."
injections:
...
//! Generated by the axum-nojs scaffold templates; edit freely.
...
pub fn form(ui: &Ui, action: &str, values: &[(String, String)], errors: &[(&str, &str)]) -> Markup {
    let form = ui
        .form(action)
{%- for f in fields %}
{%- if f.is_enum %}
