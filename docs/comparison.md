...
| CSS shipped | 69.6 KB (12.3 KB gzip), every component and block, inlined once | the SPA's | 313 KB (44 KB gzip) | yours | yours or a crate's |
| Components | 58 builders (primitives, components, widgets, six page blocks), each with its props listed, and a guide for your own | none | 84 components and 31 blocks | none | from the ecosystem |
