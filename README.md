...
like any Axum handler. `examples/loco-app` is a Loco app with sign-in and a notes model whose
HTML CRUD was generated by `cargo loco generate scaffold` from `axum-nojs/loco-templates/`.
See [`docs/loco.md`](docs/loco.md).
